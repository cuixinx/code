...
class Site(ImageList):
    ...
    image_list = {
        "baoding": "image_list/baoding.txt",
        "tianjin": "image_list/tianjin.txt",
    }
    CLASSES = ['1A', '1B', '1C', '2', '3']
    ...
    def __init__(self, root: str, task: str, download: Optional[bool] = False, **kwargs):
        ...
        super(Site, self).__init__(root, Site.CLASSES, data_list_file=data_list_file, **kwargs)
